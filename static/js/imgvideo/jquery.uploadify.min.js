	...
	var b = {
		init: function(d, e) {
			return this.each(function() {
				...
				var j = c.extend({
					id: n.attr("id"),
					swf: "http://sjs0.sinajs.cn/video/tech/zhongce/html/report/imgvideo/uploadify.swf",
		...
		onSelectError: function(d, g, f) {
			...
			if (c.inArray("onSelectError", e.overrideEvents) < 0) {
				...
				case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
					...
					//this.queueData.errorMsg += "您上传的文件超过了限制大小"+"("+e.fileSizeLimit+")，请重新选择";
					this.queueData.errorMsg += "上传失败，请使用小于5M的jpg、gif、png图片";
					break;
